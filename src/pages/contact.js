                ...
                <div className="contact w-full">
                    ...
                    <form action="https://formspree.io/f/xpzejvgg" method="post">
                        ...
                        <div className="relative z-20 w-[200px] h-[70px] sm:w-[270px] sm:mx-auto sm:h-[50px] overflow-hidden ">
                            <button type="submit"  className="okayed flex justify-center items-center rounded-lg overflow-hidden border-2 border-white w-full h-full sm:font-semibold text-white  sm:text-[10px]  max-[420px]:text-lg hover:text-black">
